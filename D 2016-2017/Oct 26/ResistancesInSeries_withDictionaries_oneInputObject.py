...
resistances_in_series_dictionary={"type":"Series","name":"resistanceInSeries","ReistanceList":resistances_in_series}
resistances_in_parallel_1=[R1,R2,R3]
resistances_parallel_1_dictionary={"type":"parallel","name":"resistanceInParallel1","ReistanceList":resistances_in_parallel_1}
resistances_in_parallel_2=[R5,R6]
resistances_parallel_2_dictionary={"type":"parallel","name":"resistanceInParallel2","ReistanceList":resistances_in_parallel_2}
...
for resistance in resistances_in_series:
    print "here is the next resistance!!: "
    print resistance["name"]
    if resistance["type"]=="cond":
        print "this resistance is conductive!!: "
        print resistance["name"]+" conductivity is: "+str(resistance["k"])
"""
